...
// src/components/materials/ImportWarpingModal.tsx
// 3-step modal for importing Warping daily output report (.xlsx)
...
interface PreviewRow {
  ...
  denier:            number | null
  strand:            number | null
  beamCount1:        number | null
  mPerEa:            number | null
  weigValue:         number | null
  beamCount2:        number | null
...
export default function ImportWarpingModal({ onImported, onClose }: Props) {
  ...
  const handlePreview = async () => {
    ...
    try {
      ...
      fd.append('file', file)
      const res  = await fetch('/api/warping/import', { method: 'POST', body: fd })
  ...
  const handleConfirm = async () => {
    ...
    try {
      const res  = await fetch('/api/warping/import/confirm', {
        method:  'POST',
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4 border-b-[0.5px] border-outline-variant flex justify-between items-center shrink-0">
          <div>
            <h3 className="text-base font-inter font-semibold text-on-surface">Import báo cáo Warping</h3>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="bg-surface-container rounded-lg p-3 text-center">
                  ...
                  <p className="text-xs text-secondary mt-1">Máy Warping</p>
                </div>
                <div className="bg-surface-container rounded-lg p-3 text-center">
          ...
          {step === 'success' && (
            <div className="flex flex-col items-center justify-center py-8 gap-4">
              ...
              <p className="text-sm text-secondary text-center">Dữ liệu Warping đã được lưu vào hệ thống.</p>
            </div>
          )}
        </div>
